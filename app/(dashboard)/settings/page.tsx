      ...
      <div className="max-w-lg mx-auto px-8 py-6 space-y-4">
        ...
        <div className="card-depth p-5">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-8 bg-morphe-orange/10 border border-morphe-orange/20 rounded-lg flex items-center justify-center">
              <Zap size={14} className="text-morphe-orange" />
            </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="btn-glow text-xs px-4 py-2">
              Upgrade para Pro
            </button>
          </div>
        </div>
